...
import com.hxt.oj.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        List<JudeCase> judgeCase = questionAddRequest.getJudgeCase();
        if (judgeCase!= null) {
            question.setJudgeCase(JSONUtil.toJsonStr(judgeCase));
        }
        JudeConfig judgeConfig = questionAddRequest.getJudgeConfig();
        if (judgeConfig!= null) {
    ...
    public BaseResponse<Boolean> updateQuestion(@RequestBody QuestionUpdateRequest questionUpdateRequest) {
        ...
        List<JudeCase> judgeCase = questionUpdateRequest.getJudgeCase();
        if (judgeCase!= null) {
            question.setJudgeCase(JSONUtil.toJsonStr(judgeCase));
        }
        JudeConfig judgeConfig = questionUpdateRequest.getJudgeConfig();
        if (judgeConfig!= null) {
            question.setJudgeConfig(JSONUtil.toJsonStr(judgeConfig));
        }
        // 参数校验
